...
public class Main {
	...
	public static void main(String[] args) throws NumberFormatException, Exception {
		try {
			// argsの値は文字列の0が入っている
			System.out.println(training03("0"));
	...
	public static String training03(String result) {
		...
		if (changeNumResult == 0 && cpu == 2 || changeNumResult == 2 && cpu == 5 || changeNumResult == 5 && cpu == 0) {
			result = "勝ち";
		} else if (changeNumResult == 0 && cpu == 0 || changeNumResult == 2 && cpu == 2
				|| changeNumResult == 5 && cpu == 5) {
			result = "あいこ";
		} else {
			result = "まけ";
		}
		...
		while (result == "あいこ") {
			...
			// 条件 0 グー, 2チョキー, 5パー
			if (changeNumResult == 0 && cpu2 == 2 || changeNumResult == 2 && cpu2 == 5
					|| changeNumResult == 5 && cpu == 0) {
				result = "勝ち";
				break;
			} else if (changeNumResult == 0 && cpu2 == 0 || changeNumResult == 2 && cpu2 == 2
					|| changeNumResult == 5 && cpu2 == 5) {
				result = "あいこ";
				break;
			} else {
				result = "まけ";
